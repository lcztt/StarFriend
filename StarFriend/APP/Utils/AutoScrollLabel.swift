...
public struct AutoScrollAttribute
{
    public static let `default` = AutoScrollAttribute()
    ...
    public init(direction: AutoScrollDirection? = nil, space: CGFloat? = nil, textFont: UIFont? = nil, textColor: UIColor? = nil) {
		if  direction == nil {
...
public class AutoScrollLabel: UIView
{
    private (set) var scrollAttribute:AutoScrollAttribute = .default
    ...
    public convenience init(frame: CGRect, scrollAttribute: AutoScrollAttribute)
    {
        self.init(frame: frame)
        self.scrollAttribute = scrollAttribute
    }
    
    public convenience init(scrollAttribute: AutoScrollAttribute)
    {
